class Mockzilla < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "937297a210c3b9351e19298542ce60b7134a8d71c01c19a9ea7886ce1f397ca1"
    else
      url "https://github.com/mockzilla/mockzilla/releases/download/v#{version}/mockzilla-v#{version}-darwin-amd64"
      sha256 "9bfd56fb662d575b7dcc84505c5da00b15becb33ffa754c3e0a4f7710e802d18"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "503178f5c9ad758e39ee1147585950ea0f7f8cb63eba8136eb2953658163172a"
    else
      url "https://github.com/mockzilla/mockzilla/releases/download/v#{version}/mockzilla-v#{version}-linux-amd64"
      sha256 "bd2248040481b782bfa8313b93371167e22ee7bba42b0f3e6b0cb3c6ff5e4f78"
    end
  end
